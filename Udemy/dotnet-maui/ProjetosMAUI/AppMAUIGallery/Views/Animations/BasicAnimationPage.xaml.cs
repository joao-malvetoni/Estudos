...
public partial class BasicAnimationPage : ContentPage
{
	...
	private void Transparencia(object sender, EventArgs e)
	{
		Image.FadeTo(0.3, 1000);
	}
	...
	private void Custom(object sender, EventArgs e)
	{
		var principal = new Animation();
 		var animacao01 = new Animation(v => Image.TranslationX = v, 0, 150, Easing.BounceOut, null);
		...
		//animacao01.Commit(this, "MoverORobo", 16, 3000, null, null, ()=>true);
	}
